  ...
  return (
    <div className='page-content'>
      ...
      <div className='page-body'>
        <DspTable col_field={columns} data_src={host+api+"services"} modal={handleOpenModalUpdate}/>
      </div>
      ...
      <Modal item_id={item_id} modal_name="services" api={api} show={isModalOpen} onClose={handleCloseModal} formAct={formAct}>
        ...
        <Input lbl={'Quantity'} id={'quantity'} typ={'text'} plc_hold={'Quantity'}/>
        <Combobox lbl={'Unit'} id={'unit'} data={['kg','pc']}/>
        <Combobox lbl={'Category'} id={'category'} data={['Services']}/>
